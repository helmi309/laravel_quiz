        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('question_text', null, ['class' => 'form-control ', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            $keys = 0            
            ?> 
            @foreach( $pilihanPertanyaan as $key => $row)
            <?php
            $keys++
            ?> 
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option'.$keys, 'Option #'.$keys, ['class' => 'control-label']) !!}
                    {!! Form::text('option'.$keys, $row, ['class' => 'form-control ', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('correct', $correct_options, old('option2'), ['class' => 'form-control', 'style' => 'height: 33px;']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('answer_explanation', null, ['class' => 'form-control ', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
